...
public class TuTorVO {
	...
	public String toString() {
		return "TuTorVO [tt_no=" + tt_no + ", tt_email=" + tt_email + ", tt_name=" + tt_name + ", tt_pass=" + tt_pass
				+ ", tt_hp=" + tt_hp + ", tt_nn=" + tt_nn + ", tt_categroy_id=" + tt_categroy_id + ", tt_reg_date="
				+ tt_reg_date + ", tt_se_date=" + tt_se_date + ", tt_tutoring=" + tt_tutoring + ", tt_acc_money="
				+ tt_acc_money + ", tt_ac_no=" + tt_ac_no + ", tt_im_path=" + tt_im_path + "]";
	}
